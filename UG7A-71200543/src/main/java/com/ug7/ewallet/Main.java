...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71200543 = new User("Abet Kalingga Wijaya", "abet.kalingga@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200543 = new GoPay(U_71200543);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200543.getUser().getNama()+"] - ");
        E_71200543.topup(50000);
        System.out.print("["+E_71200543.getUser().getNama()+"] - ");
        E_71200543.topup(9000);
